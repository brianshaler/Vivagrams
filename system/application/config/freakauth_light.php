...
+---------------------*/
 ...
 |
 */
 $config['FAL_website_name']    = "Vivagrams";
 ...
 |
 */
 $config['FAL_user_support'] = 'admin@vivagrams.com';
...
+-------------------------------------*/
 ...
 | method is index()
 */
 $config['FAL_login_uri'] = 'sessions/login';
 $config['FAL_logout_uri'] = 'sessions/logout';
 $config['FAL_register_uri'] = 'sessions/register';
 $config['FAL_activation_uri'] = 'sessions/activation';  //read the above note
 $config['FAL_changePassword_uri'] = 'sessions/changepassword';
 $config['FAL_forgottenPassword_uri'] = 'sessions/forgotten_password';
 $config['FAL_forgottenPasswordReset_uri'] = 'sessions/forgotten_password_reset'; //read the above note
 ...
 */
 ...
 // FORGOTTEN PASSWORD
  ...
  $config['FAL_forgotten_password_view'] = 'forms/forgotten_password';
  
  // view to display the successful forgotten password request
  $config['FAL_forgotten_password_success_view'] = 'forms/forgotten_password_success';
  
  // view to display the successful forgotten password reset
  $config['FAL_forgotten_password_reset_success_view'] = 'forms/forgotten_password_reset_success';
  
  // view to display the failed forgotten password reset
  $config['FAL_forgotten_password_reset_failed_view'] = 'forms/forgotten_password_reset_failed';
 ...
 // CAPTCHA VIEW
  $config['FAL_captcha_img_tag_view'] = 'forms/html_for_captcha';
...
+--------------------------*/
 ...
 $config['FAL_email_from'] = 'Brian Shaler';
 ...
 $config['FAL_forgotten_password_email'] = 'email/forgotten_password_email';
 
 // The location of the forgotten password reset email
 $config['FAL_forgotten_password_reset_email'] = 'email/forgotten_password_reset_email';
...
+-------------------*/
 ...
 $config['FAL_register_continue_action'] = 'sessions/first_login';
 
 // The action to execute after ACTIVATION, ('continue' link)
  // wether it failed or it was successful
 $config['FAL_activation_continue_action'] = 'sessions/first_login';
...
$config['FAL_admin_login_success_action'] = '';
